...
namespace API.TotalCartFunctions
{
    public class seedTotalData
    {
        public void SeedData()
        {
            ...
            string stm2 = @"CREATE TABLE carttotals(carttotalsID INTEGER PRIMARY KEY AUTO_INCREMENT, OrderID INTEGER , itemName TEXT, price DOUBLE, quantity INTEGER, FOREIGN KEY (OrderID) REFERENCES OrderIDTable(OrderID))";
