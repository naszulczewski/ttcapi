...
namespace API.CateringEventFunctions.createEvent
{
    public class seedEventData : iSeedEvent
    {
        public void SeedAllEventData()
        {
            ...
            string stm2 = @"CREATE TABLE OrderEvent(OrderID INTEGER PRIMARY KEY AUTO_INCREMENT, orderPlaced DATETIME, orderDate DATETIME, fulfilledStatus BOOL, orderEventMethod INTEGER, orderDescription TEXT)";
